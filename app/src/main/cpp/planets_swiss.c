 ...
 */
jdoubleArray
Java_planets_position_solar_SolarEclipseMapFragment_solarMapPos(JNIEnv *env, jobject this,
                                                                jdouble d_ut) {
...
Java_planets_position_riseset_RiseSetFragment_planetUpData(
        JNIEnv *env, jobject thiz, jdouble d_et, jdouble d_ut, jint p, jdoubleArray loc) {
    char serr[256];
 ...
 */
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_skyposition_SkyPositionFragment_planetPosData(JNIEnv *env, jobject this,
                                                                    jdouble d_et,
                                                                    jdouble d_ut, jint p,
                                                                    jdoubleArray loc) {
    char serr[256];
 ...
 */
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_skyposition_LivePositionFragment_planetLiveData(JNIEnv *env, jclass clazz,
                                                                      jdouble d_ut,
 ...
 */
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_lunar_eclipse_LunarEclipseTask_lunarDataLocal(JNIEnv *env, jobject thiz,
 ...
 */
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_lunar_eclipse_LunarEclipseTask_lunarDataGlobal(JNIEnv *env, jobject thiz,
                                                                     jdouble d_ut, jint back) {
    char serr[256];
    double tret[10], rval;
    int retval;
 ...
 */
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_lunar_occult_LunarOccultTask_lunarOccultLocal(JNIEnv *env, jobject thiz,
                                                                    jdouble d_ut, jdoubleArray loc,
                                                                    jint p, jint back) {
    char serr[256];
 ...
 */
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_lunar_occult_LunarOccultTask_lunarOccultGlobal(JNIEnv *env, jobject thiz,
                                                                     jdouble d_ut, jint p,
                                                                     jint back) {
    char serr[256];
    double tret[10], rval;
...
JNIEXPORT jdoubleArray JNICALL
Java_planets_position_util_PlanetCompute_planetPosData(JNIEnv *env, jobject thiz,
                                                       jdouble d_et,
                                                       jdouble d_ut, jint p,
                                                       jdoubleArray loc) {
    char serr[256];
